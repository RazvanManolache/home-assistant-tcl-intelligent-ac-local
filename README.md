...
This repository is based on `jestempablo/home-assistant-tcl-intelligent-ac` and adds the local discovery/authentication work needed for BroadLink/DNA TCL modules that report device type `0x507A` as well as `0x507C`.
...
- BroadLink/DNA device types `0x507A` and `0x507C`
